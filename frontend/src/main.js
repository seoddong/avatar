...
pluralCaseList.push( {plural: "avatars/avatars", pascal: "AvatarAvatar"} )

pluralCaseList.push( {plural: "monsters/monsters", pascal: "MonsterMonster"} )

pluralCaseList.push( {plural: "battles/battles", pascal: "BattleBattle"} )
